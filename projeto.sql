...
INSERT INTO VENDA (ID_VENDA, COD_CLIENTE, COD_TIPO, COD_MARCA, COD_PRODUTO, DATA_VENDA, VALOR_PRODUTO) VALUES
(1, 1, 1, 1, 2, '2018-11-20', '100.00'),
(2, 2, 2, 2, 1, '2018-10-22', '35.90'),
(3, 3, 3, 3, 4, '2019-05-29', '75.00'),
(4, 4, 4, 4, 3, '2019-08-09', '100.00'),
...
CREATE OR REPLACE VIEW DADOS_GERAIS_VENDA AS
	SELECT 
	V.ID_VENDA as 'Codigo', C.NOME_CLIENTE as 'Nome do Cliente', M.MARCA_NOME as 'Marca do Produto', P.NOME_PRODUTO as 'Nome do Produto', VALOR as 'Valor do Produto', DATA_VENDA as 'Data da Compra'
FROM
    VENDA V
        INNER JOIN
...
CREATE OR REPLACE VIEW DADOS_GERAIS_PRODUTO AS
	SELECT
		ID_DP as 'Codigo', P.NOME_PRODUTO as 'Nome do Produto', M.MARCA_NOME as 'Marca do Produto'
	FROM
		DADOS_PRODUTO DP
			INNER JOIN
